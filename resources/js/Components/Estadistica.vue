                    ...
                    >
                        ...
                        >
                            <div class="flex flex-row items-center p-4">
                                <div class="text-3xl p-4">💰</div>
                                <div class="p-2">
                                    <p class="text-xl font-bold">OTI</p>
                                    <p class="text-black font-medium">
                                        Totales:
                                        <slot name="otiTotal"></slot>
                                    </p>
                                    <p class="text-black text-sm font-bold">
                                        Hoy dia:
                                        <slot name="otiHoy"></slot>
                                    </p>
                                </div>
                            </div>
                            <div class="border-t border-black/20 p-4">
                        ...
                        >
                            <div class="flex flex-row items-center p-4">
                                <div class="text-3xl p-4">💰</div>
                                <div class="p-2">
                                    <p class="text-xl font-bold">Obras</p>
                                    <p class="text-black font-medium">
                                        Totales:
                                        <slot name="obrasTotal"></slot>
                                    </p>
                                    <p class="text-black text-sm font-bold">
                                        Hoy dia:
                                        <slot name="obrasHoy"></slot>
                                    </p>
                                </div>
                            </div>
                            <div class="border-t border-black/20 p-4">
