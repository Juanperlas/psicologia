    ...
    <div class="antialiased bg-slate-300 w-full text-slate-700 relative py-1">
        ...
        >
            ...
            >
                ...
                <div id="menu" class="flex flex-col space-y-2 my-5">
                    ...
                    <Link
                        ...
                        :active="route().current('reserva.index')"
                        class="hover:bg-slate-200 transition duration-150 ease-linear rounded-lg py-3 px-2 group"
                    >
                        <div
                            class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center"
                    ...
                    <Link
                        :href="route('reserva.historial')"
                        :active="route().current('reserva.historial')"
                        class="hover:bg-slate-200 transition duration-150 ease-linear rounded-lg py-3 px-2 group"
                    >
                        <div
            ...
            >
                ...
                <div
                    class="bg-gradient-to-tr from-red-300 to-yellow-200 flex justify-center items-center py-20"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            <h1
                                class="mt-4 text-gray-800 text-2xl font-bold cursor-pointer"
                            >
                                ¡Realiza tu consulta gratis AQUÍ!
                            </h1>
                            <div class="my-4">
                                ...
                                >
                                    <Link
                                        :href="route('consultas.index')"
                                        :active="
                                            route().current('consultas.index')
                                        "
                                        class="text-xl ml-2 w-full text-center justify-center hover:text-blue-200 cursor-pointer hover:-translate-y-1 duration-500 transition-all bg-indigo-600 text-white p-2 rounded-lg"
                                    >
                                        Realizar consulta
                                    </Link>
                                </div>
                        ...
                        >
                            ...
                            <h1
                                class="mt-4 text-gray-800 text-2xl font-bold cursor-pointer"
                            >
                                Realiza tu reserva para cuando tu desees
                            </h1>
                            <div class="my-4">
                                <div class="flex space-x-1 items-center">
                                    <span>
