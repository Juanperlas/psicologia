...
<template>
    <div class="antialiased bg-slate-300 w-full text-slate-700 relative py-1">
        ...
        >
            ...
            >
                <form @submit.prevent="form.post(route('consultas.store'))">
                    <div
                    ...
                    <div
                        class="editor mx-auto w-full flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-4xl"
                    >
                        <textarea
                            id="consulta"
                            v-model="form.consulta"
                            class="description bg-gray-100 sec p-3 h-80 border border-gray-300 outline-none"
                            spellcheck="false"
                        ...
                        <div class="flex justify-between">
                            <div class="mt-5">
                                <Link
                                    :href="route('consulta.todos')"
                                    :active="route().current('consulta.todos')"
                                    class="text-md ml-2 w-full text-center justify-center hover:text-blue-100 cursor-pointer hover:-translate-y-1 duration-500 transition-all bg-indigo-600 text-white p-2 rounded-lg"
                                >
                                    Ver todas las consultas
                                </Link>
                            </div>
                            <div class="mt-5 buttons flex">
                                <Link
                                    :href="route('dashboard')"
                                    :active="route().current('dashboard')"
